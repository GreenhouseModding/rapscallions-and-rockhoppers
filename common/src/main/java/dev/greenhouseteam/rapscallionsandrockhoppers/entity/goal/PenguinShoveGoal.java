...
public class PenguinShoveGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        List<Penguin> penguins = this.penguin.level().getEntitiesOfClass(Penguin.class, this.penguin.getBoundingBox().inflate(1.5, 1.0, 1.5), EntitySelector.NO_SPECTATORS.and(entity -> entity.isAlive() && entity != this.penguin));
